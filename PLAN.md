...
| **R3** | Menu simplification | repo **1.3.0**, excel-toolkit **1.5.0** | **Shipped** |
...
4. ~~R3 menu simplification.~~ **Done (excel-toolkit 1.5.0).**
...
| 0.4.0 | R3 shipped: simplified Start-ExcelMenu (pipeline / score only / export / Advanced). |
