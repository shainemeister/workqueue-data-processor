...
| [plan/slim-poi-output.md](./plan/slim-poi-output.md) | doc | Freeze: slim detail CSV + Express `POI_Scores` (identity + score-input source + four scores). |
