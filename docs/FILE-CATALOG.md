...
| [plan/slim-poi-output.md](./plan/slim-poi-output.md) | doc | Freeze: slim detail CSV + Express one-sheet `POI_Scores` Excel (identity + four scores). |
