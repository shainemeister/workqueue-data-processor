...
| **Shipped (kpi 2.10.0 / excel 1.17.0)** | Slim detail CSV + Express `POI_Scores` (frozen column order) | [plan/slim-poi-output.md](./plan/slim-poi-output.md) |
