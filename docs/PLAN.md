...
| **Shipped (kpi 2.10.0 / excel 1.15.0)** | Slim detail CSV + Express `POI_Scores` (identity + score-input source + four scores) | [plan/slim-poi-output.md](./plan/slim-poi-output.md) |
