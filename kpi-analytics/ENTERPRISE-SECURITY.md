...
Processing includes priority scoring, optional scoring-profile overlays, RCM claim-impact columns, vertical summary reporting, synthetic data generation, enterprise diagnostics, and local validation—all offline.
